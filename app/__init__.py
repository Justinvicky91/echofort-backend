...
# CORRECT DATABASE_URL from Postgres service (verified Oct 26, 2025 17:25 UTC)
CORRECT_DATABASE_URL = "postgresql://postgres:cMoeoOlFKQRoSoMfIMetyZgASlJlOHsm@postgres.railway.internal:5432/railway"

# Override the DATABASE_URL environment variable
os.environ["DATABASE_URL"] = CORRECT_DATABASE_URL

print("[FIX] DATABASE_URL hardcoded with VERIFIED correct password from Postgres service")
print(f"[FIX] Password ending: ...{CORRECT_DATABASE_URL.split(':')[2].split('@')[0][-10:]}")
