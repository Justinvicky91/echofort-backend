...
def make_app():
    s = get_settings()
    from app.admin import threat_intel, analytics, data_core, ai_command_center, ai_analysis_trigger, ai_execution_trigger, apply_block8_migrations, apply_block14_15_migrations, apply_block16_migrations, ai_chat, ai_learning, ai_investigation_api, threat_intelligence, ai_tool_status_api, apply_block24f_migration, apply_employee_fix_migration
    ...
    app.include_router(apply_employee_fix_migration.router)
    ...
    app.include_router(check_schema.router)
    from . import fix_invoices_table
    app.include_router(fix_invoices_table.router)
...
app.include_router(fix_block_s2_schema.router)
