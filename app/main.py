...
def make_app():
    ...
    if boot_mode != "bare":
        ...
        def _apply():
            ...
            for fname in ["001_init.sql", "002_rbac.sql", "003_social_time.sql", "004_new_features.sql", "005_hybrid_ai_system.sql",  "007-new-features-fixed.sql", "009-complete-reset.sql"]:
