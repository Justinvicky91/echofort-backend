                        ...
                        <table width="600" cellpadding="0" cellspacing="0" style="background-color: white; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                            ...
                            <tr>
                                <td style="padding: 40px 30px;">
                                    ...
                                    <div style="background: #f8f9fa; padding: 25px; text-align: center; border-radius: 8px; margin: 25px 0;">
                                        <div style="color: #667eea; font-size: 42px; font-weight: bold; letter-spacing: 10px; font-family: 'Courier New', monospace;">
                                            {otp_code}
                                        </div>
                                    </div>
                                    ...
                                    <div style="background: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 25px 0; border-radius: 4px;">
                                        <p style="margin: 0; color: #856404; font-size: 13px;">
                                            <strong>⚠️ Security Notice:</strong> Never share this code with anyone. EchoFort will never ask for your OTP.
                                        </p>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="background: #f8f9fa; padding: 25px 30px; border-top: 1px solid #e9ecef;">
                                    ...
                                    <p style="color: #999; font-size: 12px; margin: 0;">
                                        Need help? Contact us at <a href="mailto:{self.support_email}" style="color: #667eea; text-decoration: none;">{self.support_email}</a>
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="background: #333; padding: 20px; text-align: center;">
                                    <p style="color: #999; font-size: 12px; margin: 0;">
                                        © 2025 EchoFort AI | India's Trust Shield Against Scams
                                    </p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" style="background-color: white; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                            ...
                            <tr>
                                <td style="padding: 40px 30px;">
                                    ...
                                    <p style="color: #666; line-height: 1.8; margin: 0 0 25px 0; font-size: 15px;">
                                        Thank you for joining <strong>India's first real-time scam protection platform</strong>! 
                                    ...
                                    <div style="background: linear-gradient(135deg, #fff3cd 0%, #ffeaa7 100%); padding: 25px; border-radius: 8px; margin: 25px 0; border-left: 4px solid #ffc107;">
                                        ...
                                        <p style="color: #856404; margin: 0; font-size: 14px;">
                                            Explore all premium features absolutely free for the next 48 hours.
                                        </p>
                                    </div>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="padding: 10px 0;">
                                                ...
                                                <span style="color: #666; margin-left: 10px;">Real-time call analysis with AI</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 10px 0;">
                                                <span style="color: #28a745; font-size: 18px;">✓</span>
                                                <span style="color: #666; margin-left: 10px;">Trust Factor scoring (0-10)</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 10px 0;">
                                                <span style="color: #28a745; font-size: 18px;">✓</span>
                                                <span style="color: #666; margin-left: 10px;">Voice warnings during suspicious calls</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 10px 0;">
                                                <span style="color: #28a745; font-size: 18px;">✓</span>
                                                <span style="color: #666; margin-left: 10px;">Access to evidence library with real scam cases</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 10px 0;">
                                                <span style="color: #28a745; font-size: 18px;">✓</span>
                                                <span style="color: #666; margin-left: 10px;">24/7 protection for you and your family</span>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <div style="text-align: center; margin: 35px 0;">
                                        <a href="https://echofort.ai/dashboard" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 15px 40px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 16px;">
                            ...
                            <tr>
                                <td style="background: #f8f9fa; padding: 25px 30px; border-top: 1px solid #e9ecef;">
                                    ...
                                    <p style="color: #999; font-size: 13px; margin: 0; text-align: center;">
                                        ...
                                        <a href="mailto:{self.support_email}" style="color: #667eea; text-decoration: none;">{self.support_email}</a>
                                    </p>
                                    <p style="color: #999; font-size: 13px; margin: 10px 0 0 0; text-align: center;">
                            ...
                            <tr>
                                <td style="background: #333; padding: 20px; text-align: center;">
                                    <p style="color: #999; font-size: 12px; margin: 0 0 5px 0;">
                                        © 2025 EchoFort AI Private Limited
                                    </p>
                                    <p style="color: #999; font-size: 12px; margin: 0;">
                                        India's Trust Shield | <a href="https://echofort.ai" style="color: #667eea; text-decoration: none;">echofort.ai</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
